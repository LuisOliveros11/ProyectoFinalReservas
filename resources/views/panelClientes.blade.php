        ...
        <div id="layoutSidenav_content">
            <div id="app">
                <main class="container mt-4">
                    ...
                    <div class="modal fade" id="crearClienteModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                        aria-hidden="true">
                    ...
                    <div  v-for="(cliente, index) in obtener_clientes" :key="cliente.id">
                        <div class="modal fade" :id="'editarClienteModal'+cliente.id" :data-modal-id="cliente.id" tabindex="-1" aria-labelledby="editarClienteLabel"
                            aria-hidden="true">
                            <div class="modal-dialog">
                                <form method="POST" action="{{route(name: 'editarCliente')}}" @submit.prevent="funcion_validar_usuario($event)" :id="'editar_usuario'+cliente.id">
                                    @csrf
                                    @method('PUT')
                                    <div class="modal-content">
                                        <div class="modal-header">
                    ...
                    <div v-for="(cliente, index) in obtener_clientes" :key="cliente.id">
                        <div class="modal fade" :id="'verClienteModal'+cliente.id" :data-modal-id="cliente.id" tabindex="-1" aria-labelledby="verClienteLabel"
                            aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label for="numero_telefonico" class="form-label">Número Telefónico</label>
                                            <input type="text" class="form-control" v-model="numero_telefonico" disabled>
                                        </div>
                                        <div class="mb-3">
                                            <label for="correo_electronico" class="form-label">Correo Electrónico</label>
